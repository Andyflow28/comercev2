...
function About() {
    return (
      ...
      <main>
        ...
        <div>
            <div className="bg-violet-700 flex flex-col text-center py-5 px-10">
                <label hrtmlFor="exampleInputEmail1" className="text-cyan-600 pb-2">Give Up your E-mail</label>
                <input type="email" className="border border-violet-400 px-5 rounded-3xl" id="exampleInputEmail1" />
            </div>
