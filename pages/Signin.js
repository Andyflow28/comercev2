...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await axios.get("/api/revition");
    ...
    return (
      <div className="font-sans">
        ...
        <div className="w-screen h-screen bg-gradient-to-r from-indigo-500/50 via-purple-500/50 to-pink-500/50 flex flex-col items-center justify-center">
          <div
            className={"fixed mt-5 ml-5 cursor-pointer " + styles.fix}
            onClick={() => router.push("/")}
          >
            <Image
              alt="arrow"
          ...
          <button
            className="bg-gradient-to-t from-gray-100 text-white w-4/6 py-3 text-2xl font-extrabold rounded-b-2xl sm:w-2/6"
